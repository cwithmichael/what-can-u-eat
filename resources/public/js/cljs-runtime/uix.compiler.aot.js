...
var v__11836__auto___12417 = children;
if(cljs.core.seq(v__11836__auto___12417)){
var x__11837__auto___12419 = cljs.core.first(v__11836__auto___12417);
var xs__11838__auto___12420 = cljs.core.next(v__11836__auto___12417);
while(true){
var child_12421 = x__11837__auto___12419;
if(cljs.core.truth_(uix.compiler.aot.hiccup_QMARK_(child_12421))){
throw (new Error(["Hiccup is not valid as UIx child (found: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(child_12421),").\n","If you meant to render UIx element, use `$` macro, i.e. ($ ",clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",child_12421),")\n","If you meant to render Reagent element, wrap it with r/as-element, i.e. (r/as-element ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(child_12421),")"].join('')));
} else {
if(cljs.core.sequential_QMARK_(child_12421)){
(uix.compiler.aot.validate_children.cljs$core$IFn$_invoke$arity$1 ? uix.compiler.aot.validate_children.cljs$core$IFn$_invoke$arity$1(child_12421) : uix.compiler.aot.validate_children.call(null, child_12421));
} else {
}
}

if(cljs.core.seq(xs__11838__auto___12420)){
var G__12423 = cljs.core.first(xs__11838__auto___12420);
var G__12424 = cljs.core.next(xs__11838__auto___12420);
x__11837__auto___12419 = G__12423;
xs__11838__auto___12420 = G__12424;
continue;
} else {
}
break;
