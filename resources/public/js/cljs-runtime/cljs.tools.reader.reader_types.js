...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_13875 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_13875(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_13876 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_13876(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_13877 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_13877(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_13878 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_13878(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_13879 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_13879(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_13880 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_13880(reader);
}
});
