...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_18013 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_18013(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_18016 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_18016(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_18017 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_18017(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_18018 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_18018(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_18019 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_18019(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_18023 = (function (runtime,code){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_18023(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__18009,callback){
var map__18010 = p__18009;
var map__18010__$1 = cljs.core.__destructure_map(map__18010);
var input = map__18010__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18010__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18010__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
