...
(schema.spec.variant.VariantSpec.prototype.cljs$core$ILookup$_lookup$arity$2 = (function (this__5300__auto__,k__5301__auto__){
var self__ = this;
var this__5300__auto____$1 = this;
return this__5300__auto____$1.cljs$core$ILookup$_lookup$arity$3(null, k__5301__auto__,null);
}));

(schema.spec.variant.VariantSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5302__auto__,k13435,else__5303__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k13435,else__5303__auto__);

}
}));

(schema.spec.variant.VariantSpec.prototype.cljs$core$IKVReduce$_kv_reduce$arity$3 = (function (this__5320__auto__,f__5321__auto__,init__5322__auto__){
var self__ = this;
var this__5320__auto____$1 = this;
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5323__auto__,p__13441){
...
var G__13451 = schema.utils.value_name(x);
return (self__.err_f.cljs$core$IFn$_invoke$arity$1 ? self__.err_f.cljs$core$IFn$_invoke$arity$1(G__13451) : self__.err_f.call(null, G__13451));
}),null)),null));
...
var or__5002__auto____$1 = (function (){var G__13454 = (cljs.core.truth_(new cljs.core.Keyword(null,"return-walked?","return-walked?",-1684646015).cljs$core$IFn$_invoke$arity$1(params))?v:x);
return (self__.post.cljs$core$IFn$_invoke$arity$1 ? self__.post.cljs$core$IFn$_invoke$arity$1(G__13454) : self__.post.call(null, G__13454));
})();
...
(schema.spec.variant.VariantSpec.prototype.cljs$core$ICounted$_count$arity$1 = (function (this__5304__auto__){
var self__ = this;
var this__5304__auto____$1 = this;
return (4 + cljs.core.count(self__.__extmap));
}));

(schema.spec.variant.VariantSpec.prototype.cljs$core$IHash$_hash$arity$1 = (function (this__5296__auto__){
var self__ = this;
...
return (-1524878868 ^ cljs.core.hash_unordered_coll(coll__5297__auto__));
...
(schema.spec.variant.VariantSpec.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this13436,other13437){
var self__ = this;
var this13436__$1 = this;
return (((!((other13437 == null)))) && ((((this13436__$1.constructor === other13437.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this13436__$1.pre,other13437.pre)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this13436__$1.options,other13437.options)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this13436__$1.err_f,other13437.err_f)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this13436__$1.post,other13437.post)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this13436__$1.__extmap,other13437.__extmap)))))))))))));
}));

(schema.spec.variant.VariantSpec.prototype.cljs$core$IMap$_dissoc$arity$2 = (function (this__5310__auto__,k__5311__auto__){
var self__ = this;
var this__5310__auto____$1 = this;
if(cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"pre","pre",2118456869),null,new cljs.core.Keyword(null,"err-f","err-f",651620941),null,new cljs.core.Keyword(null,"post","post",269697687),null,new cljs.core.Keyword(null,"options","options",99638489),null], null), null),k__5311__auto__)){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core._with_meta(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,this__5310__auto____$1),self__.__meta),k__5311__auto__);
} else {
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,self__.__meta,cljs.core.not_empty(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(self__.__extmap,k__5311__auto__)),null));
}
}));

(schema.spec.variant.VariantSpec.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5307__auto__,k13435){
var self__ = this;
...
(schema.spec.variant.VariantSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5308__auto__,k__5309__auto__,G__13434){
var self__ = this;
var this__5308__auto____$1 = this;
var pred__13464 = cljs.core.keyword_identical_QMARK_;
var expr__13465 = k__5309__auto__;
if(cljs.core.truth_((pred__13464.cljs$core$IFn$_invoke$arity$2 ? pred__13464.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"pre","pre",2118456869),expr__13465) : pred__13464.call(null, new cljs.core.Keyword(null,"pre","pre",2118456869),expr__13465)))){
return (new schema.spec.variant.VariantSpec(G__13434,self__.options,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__13464.cljs$core$IFn$_invoke$arity$2 ? pred__13464.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"options","options",99638489),expr__13465) : pred__13464.call(null, new cljs.core.Keyword(null,"options","options",99638489),expr__13465)))){
return (new schema.spec.variant.VariantSpec(self__.pre,G__13434,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__13464.cljs$core$IFn$_invoke$arity$2 ? pred__13464.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"err-f","err-f",651620941),expr__13465) : pred__13464.call(null, new cljs.core.Keyword(null,"err-f","err-f",651620941),expr__13465)))){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,G__13434,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__13464.cljs$core$IFn$_invoke$arity$2 ? pred__13464.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"post","post",269697687),expr__13465) : pred__13464.call(null, new cljs.core.Keyword(null,"post","post",269697687),expr__13465)))){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,G__13434,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5309__auto__,G__13434),null));
}
}
}
}
...
(schema.spec.variant.VariantSpec.prototype.cljs$core$ISeqable$_seq$arity$1 = (function (this__5313__auto__){
var self__ = this;
...
(schema.spec.variant.VariantSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5299__auto__,G__13434){
var self__ = this;
var this__5299__auto____$1 = this;
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,G__13434,self__.__extmap,self__.__hash));
}));

(schema.spec.variant.VariantSpec.prototype.cljs$core$ICollection$_conj$arity$2 = (function (this__5305__auto__,entry__5306__auto__){
var self__ = this;
...
(schema.spec.variant.VariantSpec.cljs$lang$ctorPrSeq = (function (this__5346__auto__){
return (new cljs.core.List(null,"schema.spec.variant/VariantSpec",null,(1),null));
}));

(schema.spec.variant.VariantSpec.cljs$lang$ctorPrWriter = (function (this__5346__auto__,writer__5347__auto__){
return cljs.core._write(writer__5347__auto__,"schema.spec.variant/VariantSpec");
}));
 ...
 */
schema.spec.variant.map__GT_VariantSpec = (function schema$spec$variant$map__GT_VariantSpec(G__13438){
var extmap__5342__auto__ = (function (){var G__13469 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__13438,new cljs.core.Keyword(null,"pre","pre",2118456869),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.Keyword(null,"err-f","err-f",651620941),new cljs.core.Keyword(null,"post","post",269697687)], 0));
if(cljs.core.record_QMARK_(G__13438)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__13469);
} else {
return G__13469;
}
})();
return (new schema.spec.variant.VariantSpec(new cljs.core.Keyword(null,"pre","pre",2118456869).cljs$core$IFn$_invoke$arity$1(G__13438),new cljs.core.Keyword(null,"options","options",99638489).cljs$core$IFn$_invoke$arity$1(G__13438),new cljs.core.Keyword(null,"err-f","err-f",651620941).cljs$core$IFn$_invoke$arity$1(G__13438),new cljs.core.Keyword(null,"post","post",269697687).cljs$core$IFn$_invoke$arity$1(G__13438),null,cljs.core.not_empty(extmap__5342__auto__),null));
});
...
if(cljs.core.truth_((function (){var or__5002__auto__ = err_f;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
