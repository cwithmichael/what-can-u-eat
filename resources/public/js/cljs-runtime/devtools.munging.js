...
var o12581 = temp__5802__auto__;
var temp__5802__auto____$1 = (o12581["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o12582 = temp__5802__auto____$1;
return (o12582["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__12139__auto__ = f;
return (o__12139__auto__["toString"]).call(o__12139__auto__);
} else {
return "";
}
...
try{var o__12139__auto___12835 = t;
(o__12139__auto___12835["cljs$lang$ctorPrWriter"]).call(o__12139__auto___12835,t,writer);
}catch (e12585){var __12836 = e12585;
}
...
var char_code = (function (){var o__12139__auto__ = (new String(char$));
return (o__12139__auto__["charCodeAt"]).call(o__12139__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__12139__auto__ = String;
return (o__12139__auto__["fromCharCode"]).call(o__12139__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12600 = num_code;
switch (G__12600) {
case (1):
return (185);
...
var o__12139__auto__ = String;
return (o__12139__auto__["fromCharCode"]).call(o__12139__auto__,superscript_code);
});
/**
...
}catch (e12616){var _e__12191__auto__ = e12616;
return false;
}})())){
...
var vec__12619 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12619,(0),null);
...
var len__5726__auto___12845 = arguments.length;
var i__5727__auto___12846 = (0);
while(true){
if((i__5727__auto___12846 < len__5726__auto___12845)){
args__5732__auto__.push((arguments[i__5727__auto___12846]));

var G__12847 = (i__5727__auto___12846 + (1));
i__5727__auto___12846 = G__12847;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__12631){
var vec__12633 = p__12631;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12633,(0),null);
...
var G__12854 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__12855 = cljs.core.butlast(remaining_tokens);
name_tokens = G__12854;
remaining_tokens = G__12855;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq12629){
var G__12630 = cljs.core.first(seq12629);
var seq12629__$1 = cljs.core.next(seq12629);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12630,seq12629__$1);
}));
...
var vec__12641 = cljs.core.split_with((function (p1__12640_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__12640_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12641,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12641,(1),null);
...
var vec__12648 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12648,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12648,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__12860 = cljs.core.rest(remaining_tokens);
var G__12861 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__12860;
name_tokens = G__12861;
continue;
} else {
...
var vec__12659 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12659,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12659,(1),null);
var vec__12662 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12662,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12662,(1),null);
var vec__12665 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12665,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12665,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12665,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12665,(3),null);
...
var vec__12674 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12674,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12674,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12674,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12674,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12674,(4),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__12677 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12677,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12677,(1),null);
var vec__12680 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12680,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12680,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__12683 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__12683) : devtools.munging.parse_fn_info_deep.call(null, G__12683));
})()));
}
} else {
return fn_info;
...
var G__12893 = (arity + (1));
var G__12894 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12713){
var vec__12714 = p__12713;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12714,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12714,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12720_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__12720_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12721_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__12721_SHARP_);
}),sorted_infos);
...
var G__12908 = (i__5727__auto___12906 + (1));
i__5727__auto___12906 = G__12908;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12732){
var vec__12733 = p__12732;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12733,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12725){
...
var map__12757 = options;
var map__12757__$1 = cljs.core.__destructure_map(map__12757);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12757__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12757__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12757__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12757__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12758 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12758,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12758,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12758,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12758,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12758,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12758,(5),null);
...
var o__12139__auto__ = f;
return (o__12139__auto__["getBasis"]).call(o__12139__auto__);
});
/**
...
}catch (e12764){var _e__12191__auto__ = e12764;
...
var G__12963 = (obj[cljs.core.first(path)]);
var G__12964 = cljs.core.rest(path);
obj = G__12963;
path = G__12964;
continue;
} else {
...
var _STAR_ = (function (accum,p__12791){
var vec__12794 = p__12791;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12794,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12794,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12804){
var vec__12805 = p__12804;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12805,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12805,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12805,(2),null);
...
var post_process = (function (p__12812){
var vec__12813 = p__12812;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12813,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12813,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12808_SHARP_){
return (obj[cljs.core.first(p1__12808_SHARP_)]);
}),sorted_matches);
