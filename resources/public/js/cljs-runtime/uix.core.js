 ...
 */
uix.core.create_class = (function uix$core$create_class(p__13178){
var map__13179 = p__13178;
var map__13179__$1 = cljs.core.__destructure_map(map__13179);
var fields = map__13179__$1;
var contextType = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13179__$1,new cljs.core.Keyword(null,"contextType","contextType",1033066077));
var componentDidUpdate = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13179__$1,new cljs.core.Keyword(null,"componentDidUpdate","componentDidUpdate",-1983477981));
var componentDidCatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13179__$1,new cljs.core.Keyword(null,"componentDidCatch","componentDidCatch",821717733));
var displayName = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13179__$1,new cljs.core.Keyword(null,"displayName","displayName",-809144601));
var childContextTypes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13179__$1,new cljs.core.Keyword(null,"childContextTypes","childContextTypes",578717991));
var getSnapshotBeforeUpdate = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13179__$1,new cljs.core.Keyword(null,"getSnapshotBeforeUpdate","getSnapshotBeforeUpdate",861122184));
var contextTypes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13179__$1,new cljs.core.Keyword(null,"contextTypes","contextTypes",-2023853910));
var getDerivedStateFromProps = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13179__$1,new cljs.core.Keyword(null,"getDerivedStateFromProps","getDerivedStateFromProps",-991834739));
var getDerivedStateFromError = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13179__$1,new cljs.core.Keyword(null,"getDerivedStateFromError","getDerivedStateFromError",166658477));
var componentWillUnmount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13179__$1,new cljs.core.Keyword(null,"componentWillUnmount","componentWillUnmount",1573788814));
var shouldComponentUpdate = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13179__$1,new cljs.core.Keyword(null,"shouldComponentUpdate","shouldComponentUpdate",1795750960));
var render = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13179__$1,new cljs.core.Keyword(null,"render","render",-1408033454));
var defaultProps = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13179__$1,new cljs.core.Keyword(null,"defaultProps","defaultProps",-533483149));
var getInitialState = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13179__$1,new cljs.core.Keyword(null,"getInitialState","getInitialState",1541760916));
var constructor$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13179__$1,new cljs.core.Keyword(null,"constructor","constructor",-1953928811));
var componentDidMount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13179__$1,new cljs.core.Keyword(null,"componentDidMount","componentDidMount",955710936));
...
var G__13180 = props.argv;
if(cljs.core.truth_(props.children)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13180,new cljs.core.Keyword(null,"children","children",-940561982),props.children);
} else {
return G__13180;
}
});
...
if((ref.current == null)){
(ref.current = (function (){var x13187 = ({"current": value});
(x13187.cljs$core$IDeref$ = cljs.core.PROTOCOL_SENTINEL);

(x13187.cljs$core$IDeref$_deref$arity$1 = (function (this$){
var this$__$1 = this;
return this$__$1.current;
}));

(x13187.cljs$core$IReset$ = cljs.core.PROTOCOL_SENTINEL);

(x13187.cljs$core$IReset$_reset_BANG_$arity$2 = (function (this$,v){
var this$__$1 = this;
return (this$__$1.current = v);
}));

(x13187.cljs$core$ISwap$ = cljs.core.PROTOCOL_SENTINEL);

(x13187.cljs$core$ISwap$_swap_BANG_$arity$2 = (function (this$,f){
var this$__$1 = this;
return (this$__$1.current = (function (){var G__13188 = this$__$1.current;
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__13188) : f.call(null, G__13188));
})());
}));

(x13187.cljs$core$ISwap$_swap_BANG_$arity$3 = (function (this$,f,a){
var this$__$1 = this;
return (this$__$1.current = (function (){var G__13189 = this$__$1.current;
var G__13190 = a;
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__13189,G__13190) : f.call(null, G__13189,G__13190));
})());
}));

(x13187.cljs$core$ISwap$_swap_BANG_$arity$4 = (function (this$,f,a,b){
var this$__$1 = this;
return (this$__$1.current = (function (){var G__13191 = this$__$1.current;
var G__13192 = a;
var G__13193 = b;
...
(x13187.cljs$core$ISwap$_swap_BANG_$arity$5 = (function (this$,f,a,b,xs){
var this$__$1 = this;
...
var G__13201 = cljs_bean.core.bean.cljs$core$IFn$_invoke$arity$1(p1__13200_SHARP_);
 ...
 */
uix.core.create_error_boundary = (function uix$core$create_error_boundary(p__13204,render_fn){
var map__13205 = p__13204;
var map__13205__$1 = cljs.core.__destructure_map(map__13205);
var display_name = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__13205__$1,new cljs.core.Keyword(null,"display-name","display-name",694513143),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.gensym.cljs$core$IFn$_invoke$arity$1("uix.error-boundary")));
var derive_error_state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13205__$1,new cljs.core.Keyword(null,"derive-error-state","derive-error-state",-1373095498));
var did_catch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13205__$1,new cljs.core.Keyword(null,"did-catch","did-catch",2139522313));
...
var G__13206 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [state.argv,set_state], null);
var G__13207 = uix.core.glue_args(props);
return (render_fn.cljs$core$IFn$_invoke$arity$2 ? render_fn.cljs$core$IFn$_invoke$arity$2(G__13206,G__13207) : render_fn.call(null, G__13206,G__13207));
});
...
var argv = (function (){var G__13208 = props.argv;
var G__13208__$1 = (cljs.core.truth_(props.children)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13208,new cljs.core.Keyword(null,"children","children",-940561982),props.children):G__13208);
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13208__$1,new cljs.core.Keyword(null,"ref","ref",1289896967),ref);
...
var update_children = (function (p1__13209_SHARP_){
if(cljs.core.truth_(p1__13209_SHARP_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (el){
if(cljs.core.truth_((function (){var G__13213 = el;
if((G__13213 == null)){
return null;
} else {
return G__13213._store;
}
})())){
...
var nel = uix.compiler.alpha.component_element(type,uix.compiler.attributes.interpret_props((function (){var G__13214 = props__$1;
if(cljs.core.seq(children__$1)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13214,new cljs.core.Keyword(null,"children","children",-940561982),cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(children__$1));
} else {
return G__13214;
}
})()),[]);
...
return uix.compiler.alpha.component_element(type,uix.compiler.attributes.interpret_props((function (){var G__13215 = oprops;
var G__13215__$1 = (cljs.core.truth_(okey)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13215,new cljs.core.Keyword(null,"key","key",-1516042587),okey):G__13215);
var G__13215__$2 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([G__13215__$1,props__$1], 0))
;
if(cljs.core.seq(children__$1)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13215__$2,new cljs.core.Keyword(null,"children","children",-940561982),children__$1);
} else {
return G__13215__$2;
}
})()),[]);
...
/** @this {Function} */
(uix.core.clone_element.cljs$lang$applyTo = (function (seq13210){
...
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13211,G__13212,seq13210__$2);
}));
