...
return cljs.core.some((function (p1__11923_SHARP_){
if(clojure.string.starts_with_QMARK_(p1__11923_SHARP_,"G_")){
return (component_type === uix.compiler.alpha.goog$module$goog$object.get(component_type,p1__11923_SHARP_));
} else {
return null;
}
...
var name_str_11978 = (function (){var or__5002__auto__ = component_type.displayName;
...
throw (new Error(["Invalid use of Reagent component ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(name_str_11978)," in `$` form.\n","UIx doesn't know how to render Reagent components.\n","Reagent element should be Hiccup wrapped with r/as-element, i.e. (r/as-element [",cljs.core.str.cljs$core$IFn$_invoke$arity$1(name_str_11978),"])"].join('')));
} else {
}
...
if(and__5000__auto__){
var G__11926 = x;
var G__11926__$1 = (((G__11926 == null))?null:G__11926.constructor);
if((G__11926__$1 == null)){
return null;
} else {
return (G__11926__$1 === Object);
}
} else {
return and__5000__auto__;
}
