...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__22992 = c;
var G__22992__$1 = (((G__22992 == null))?null:G__22992.prototype);
if((G__22992__$1 == null)){
return null;
} else {
return G__22992__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__22996 = c;
var G__22996__$1 = (((G__22996 == null))?null:G__22996.prototype);
if((G__22996__$1 == null)){
return null;
} else {
return G__22996__$1.render;
}
})() == null)))));
});
...
while (G__23088__i < G__23088__a.length) {G__23088__a[G__23088__i] = arguments[G__23088__i + 0]; ++G__23088__i;}
  args = new cljs.core.IndexedSeq(G__23088__a,0,null);
} 
...
var args = cljs.core.seq(arglist__23089);
...
var or__5002__auto__ = (function (){var G__23004 = c;
var G__23004__$1 = (((G__23004 == null))?null:G__23004.constructor);
if((G__23004__$1 == null)){
return null;
} else {
return G__23004__$1.displayName;
}
})();
...
var G__23005 = c;
var G__23005__$1 = (((G__23005 == null))?null:G__23005.constructor);
if((G__23005__$1 == null)){
return null;
} else {
return G__23005__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__23016 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__23017 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__23017);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__23016);
}});
...
var c = this;
var G__23070_23095 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__23070_23095 == null)){
} else {
reagent.ratom.dispose_BANG_(G__23070_23095);
}
...
var renders_23096 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_23097 = cljs.core.first(cljs.core.vals(renders_23096));
...
if((cljs.core.count(renders_23096) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_23096))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_23097)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_23097], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__23078 = o;
reagent.impl.component.goog$module$goog$object.set(G__23078,cljs.core.name(k),v);
...
while (G__23101__i < G__23101__a.length) {G__23101__a[G__23101__i] = arguments[G__23101__i + 0]; ++G__23101__i;}
  args = new cljs.core.IndexedSeq(G__23101__a,0,null);
} 
...
var args = cljs.core.seq(arglist__23102);
...
var vec__23081 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23081,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23081,(1),null);
...
var G__23084 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__23084 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__23084);
}
});
}),[]);
