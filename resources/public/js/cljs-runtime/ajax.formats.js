...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__12129){
var map__12130 = p__12129;
var map__12130__$1 = cljs.core.__destructure_map(map__12130);
var request = map__12130__$1;
...
var fexpr__12134 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__12134.cljs$core$IFn$_invoke$arity$1 ? fexpr__12134.cljs$core$IFn$_invoke$arity$1(response) : fexpr__12134.call(null, response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__12135 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__12135.cljs$core$IFn$_invoke$arity$1 ? fexpr__12135.cljs$core$IFn$_invoke$arity$1(response) : fexpr__12135.call(null, response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__12136){
var map__12137 = p__12136;
var map__12137__$1 = cljs.core.__destructure_map(map__12137);
var request = map__12137__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12137__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
