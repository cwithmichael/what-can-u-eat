...
var len__5726__auto___12919 = arguments.length;
var i__5727__auto___12920 = (0);
while(true){
if((i__5727__auto___12920 < len__5726__auto___12919)){
args__5732__auto__.push((arguments[i__5727__auto___12920]));

var G__12921 = (i__5727__auto___12920 + (1));
i__5727__auto___12920 = G__12921;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq12875){
...
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12876,G__12877,seq12875__$2);
}));
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12888__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e12889){var _e__12191__auto__ = e12889;
return false;
}})();
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
...
}catch (e12891){var _e__12191__auto__ = e12891;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__12895 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__12896 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__12896);

try{var map__12897 = opts;
var map__12897__$1 = cljs.core.__destructure_map(map__12897);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12897__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__12895);
}});
...
var _STAR_print_level_STAR__orig_val__12912_12977 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__12913_12978 = managed_print_level_12976;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__12913_12978);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__12907_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__12907_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__12912_12977);
}} else {
job_fn();
}
