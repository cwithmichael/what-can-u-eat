...
var G__11993 = cljs.core.next(xs);
var G__11994 = cljs.core.next(ys);
xs = G__11993;
ys = G__11994;
continue;
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__11909 = val;
var G__11910 = cicoll.cljs$core$IIndexed$_nth$arity$2(null, n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__11909,G__11910) : f.call(null, G__11909,G__11910));
})();
...
while(true){
if((n < cnt)){
var nval = (function (){var G__11912 = val__$1;
var G__11913 = cicoll.cljs$core$IIndexed$_nth$arity$2(null, n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__11912,G__11913) : f.call(null, G__11912,G__11913));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__11915 = val__$1;
var G__11916 = cicoll.cljs$core$IIndexed$_nth$arity$2(null, n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__11915,G__11916) : f.call(null, G__11915,G__11916));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
var G__12059 = cljs.core.next(es);
var G__12061 = cljs.core._assoc_BANG_(tcoll__$1,cljs.core.key(e),cljs.core.val(e));
es = G__12059;
tcoll__$1 = G__12061;
continue;
} else {
...
var G__12076 = cljs.core._assoc(ret,cljs.core._nth(e,(0)),cljs.core._nth(e,(1)));
var G__12077 = cljs.core.next(es);
ret = G__12076;
es = G__12077;
continue;
} else {
