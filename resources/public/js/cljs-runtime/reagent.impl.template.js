...
var G__23106 = o;
reagent.impl.template.goog$module$goog$object.set(G__23106,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
return (function() { 
var G__23124__delegate = function (args){
...
while (G__23125__i < G__23125__a.length) {G__23125__a[G__23125__i] = arguments[G__23125__i + 0]; ++G__23125__i;}
  args = new cljs.core.IndexedSeq(G__23125__a,0,null);
} 
return G__23124__delegate.call(this,args);};
G__23124.cljs$lang$maxFixedArity = 0;
G__23124.cljs$lang$applyTo = (function (arglist__23126){
var args = cljs.core.seq(arglist__23126);
return G__23124__delegate(args);
});
...
var G__23107 = o;
reagent.impl.template.goog$module$goog$object.set(G__23107,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__23129__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__23131__i < G__23131__a.length) {G__23131__a[G__23131__i] = arguments[G__23131__i + 0]; ++G__23131__i;}
  args = new cljs.core.IndexedSeq(G__23131__a,0,null);
} 
return G__23129__delegate.call(this,args);};
G__23129.cljs$lang$maxFixedArity = 0;
G__23129.cljs$lang$applyTo = (function (arglist__23132){
var args = cljs.core.seq(arglist__23132);
return G__23129__delegate(args);
});
...
var G__23108 = props;
var G__23108__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23108,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__23108);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23108__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__23109 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23109,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__23109;
}
})(),id_class);
...
var G__23110 = (cljs.core.count(argv) - first_child);
switch (G__23110) {
case (0):
...
var vec__23111 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23111,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23111,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23111,(2),null);
...
var temp__5808__auto___23141 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___23141 == null)){
} else {
var key_23142 = temp__5808__auto___23141;
(jsprops.key = key_23142);
}
...
var temp__5808__auto___23143 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___23143 == null)){
} else {
var key_23144 = temp__5808__auto___23143;
(jsprops.key = key_23144);
}
...
var temp__5808__auto___23147 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___23147 == null)){
} else {
var key_23149 = temp__5808__auto___23147;
(jsprops.key = key_23149);
}
...
var temp__5808__auto___23157 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___23157 == null)){
} else {
var key_23158 = temp__5808__auto___23157;
(jsprops.key = key_23158);
}
...
var temp__5808__auto___23159 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___23159 == null)){
} else {
var key_23160 = temp__5808__auto___23159;
(jsprops.key = key_23160);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__23114_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__23114_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__23115 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23115,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23115,(1),null);
...
break;
default:
var G__23162 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__23163 = compiler;
v = G__23162;
compiler = G__23163;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template23121 = (function (opts,id,fn_to_element,parse_fn,meta23122){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template23121.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_23123,meta23122__$1){
var self__ = this;
var _23123__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template23121(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta23122__$1));
}));

(reagent.impl.template.t_reagent$impl$template23121.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_23123){
var self__ = this;
var _23123__$1 = this;
return self__.meta23122;
}));

(reagent.impl.template.t_reagent$impl$template23121.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template23121.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template23121.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template23121.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template23121.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template23121.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta23122","meta23122",1507614557,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template23121.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template23121.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template23121");

(reagent.impl.template.t_reagent$impl$template23121.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template23121");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template23121.
 */
reagent.impl.template.__GT_t_reagent$impl$template23121 = (function reagent$impl$template$__GT_t_reagent$impl$template23121(opts,id,fn_to_element,parse_fn,meta23122){
return (new reagent.impl.template.t_reagent$impl$template23121(opts,id,fn_to_element,parse_fn,meta23122));
});
...
return (new reagent.impl.template.t_reagent$impl$template23121(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
